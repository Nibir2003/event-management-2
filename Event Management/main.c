...
{
    printf(" **********************************************************************\n");
    printf(" *                   Contact us : +8801996646545                   *\n");
    printf(" *           Email Address: yousha.nibir@northsouth.edu            *\n");
    printf(" *                                                                    *\n");
    printf(" **********************************************************************\n\n");
    ...
    printf("    tt     tt   tt tt  tt tt     ttt tt   tt       tt     tttt   ttttt\      n");
